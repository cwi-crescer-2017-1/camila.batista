var c = angular.module('crud', ['ngRoute']);

c.config(function($routeProvider){
  $routeProvider
    .when('/paginaAulas',{
      controller: 'controllerAula',
      templateUrl: 'paginaAulas.html'
    })
    .when('/paginaInstrutores', {
      controller: 'controllerInstrutores',
      templateUrl: 'paginaInstrutores.html'
    })
    .otherwise({redirectTo: '/paginaAulas'});

});

c.controller('controllerAula', function($scope){
  let mostrarAula;
  let edita = false;
...
c.controller('controllerInstrutores', function($scope){
...
c.controller('principal', function($scope){
